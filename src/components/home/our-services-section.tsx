...
import { AppliancesComponent, CustomCabinetsComponent, ElectricalComponent, FurnitureComponent, KitchenComponent, PlumbingComponent, } from "./our-services-components"
    ...
    <div id="services" className="py-16 lg:px-32 md:px-16 px-4">
      ...
      <div className="grid grid-cols-3 gap-5 md:grid-cols-6 pt-16 pb-20 place-items-center place-content-center">
        <button className={buttonClassNames} onClick={() => setItemName("painting")}>
          <Image src={Cabinets} width={dimension} height={dimension} alt="Painting" className="mt-2" />
          <p className="text-xs font-semibold pt-2">Custom Cabinets</p>
        </button>
        <button className={buttonClassNames} onClick={() => setItemName("appliances")}>
          <Image src={WashingMachine} width={dimension} height={dimension} alt="Painting" />
          <p className="text-xs font-semibold">Appliances</p>
        </button>
        <button className={buttonClassNames} onClick={() => setItemName("plumbing")}>
          <Image src={Plumbing} width={dimension} height={dimension} alt="Painting" />
          <p className="text-xs font-semibold">Plumbing</p>
        </button>
        <button className={buttonClassNames} onClick={() => setItemName("electrical")}>
          <Image src={Electrical} width={dimension} height={dimension} alt="Painting" />
          <p className="text-xs font-semibold pt-2">Electrical</p>
        </button>
        <button className={buttonClassNames} onClick={() => setItemName("furniture")}>
          <Image className="mt-3.5" src={Furniture} width={isSmallScreen ? 30 : 40} height={isSmallScreen ? 30 : 40} alt="Painting" />
          <p className="text-xs font-semibold">Furniture</p>
        </button>
        <button className={buttonClassNames} onClick={() => setItemName("repair")}>
          <Image src={Repair} width={dimension} height={isSmallScreen ? 30 : 40} alt="Painting" />
        ...
        <div className="flex flex-col-reverse gap-6 lg:gap-0 lg:flex-row justify-evenly items-center lg:items-start">
          <AnimatePresence mode="wait" initial={false}>
          {
            ...
            :
            itemName === "appliances" ? <AppliancesComponent /> 
            :
            ...
            :
            itemName === "painting" ? <CustomCabinetsComponent />
            : null
          }
          </AnimatePresence>
        </div>
