...
import Furniture from "@/assets/our-services/furniture.jpg"
import Plumbing from "@/assets/our-services/plumbing.jpg"
      ...
      >
        ...
        <ul className="list-disc ml-5">
          ...
          <li>
            ...
            <br />
            (Specializes in Luxury Appliance)
          </li>
          <li>Door Panels</li>
...
export const MinorRepairsComponent = () => {
  return (
    <>
      <motion.div
        key="kitchen-left"
      ...
      <motion.div
        ...
        {...commonRightAnimations}
      >
        <Image className="shadow-2xl" src={MinorRepair} alt="viking" />
      </motion.div>
    </>
  );
};
  ...
  return (
    <>
      ...
      <motion.div
        ...
        {...commonRightAnimations}
      >
        <Image className="shadow-2xl" src={Plumbing} alt="viking" />
      </motion.div>
    </>
  );
};
...
export const ElectricalComponent = () => {
  return (
    <>
      ...
      <motion.div
        key="electrical-right"
        className="w-full lg:w-1/2"
        {...commonRightAnimations}
      >
        <Image className="shadow-2xl" src={Electircal} alt="viking" />
      </motion.div>
    </>
  );
};
  ...
  return (
    <>
      ...
      <motion.div
        ...
        {...commonRightAnimations}
      >
        <Image className="shadow-2xl" src={Furniture} alt="viking" />
      </motion.div>
    </>
  );
};
  ...
  return (
    <>
      ...
      >
        ...
        <ul className="list-disc ml-5">
          <li>
            We offer expert design, build, and installation services for custom
            cabinets tailored specifically to enhance the functionality and
            aesthetics of your kitchen, bathroom, and den area. Our team works
            closely with you to create personalized cabinetry solutions that
            meet your unique needs, using high-quality materials and precise
            craftsmanship to ensure a perfect fit in every room of your home.
          </li>
        </ul>
      </motion.div>
      <motion.div
        ...
        {...commonRightAnimations}
      >
        <Image className="shadow-2xl" src={CustomCabinets} alt="viking" />
      </motion.div>
    </>
  );
};
