...
export default function HeroSection() {
  ...
  return (
    <div className="h-screen flex items-center justify-center sm:justify-start" style={{backgroundImage: `linear-gradient(to right, rgba(0,0,0,0.8), transparent), url(${heroBackground.src})`, backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "center"}}>
